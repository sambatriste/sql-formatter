...
/**
 * {@link org.hibernate.engine.jdbc.internal.BasicFormatterImpl}をカスタマイズしたフォーマッタ。
 *
 * <pre>
 * | 項目           | BasicFormatterImpl | CustomFormatter |
 * |----------------|--------------------|-----------------|
 * | インデント     | 4スペース          | 2スペース       |
 * | 初期インデント | 1                  | 0               |
 * | 開始行         | 改行あり           | 改行なし        |
 * </pre>
 *
 * @see org.hibernate.engine.jdbc.internal.BasicFormatterImpl
 */
